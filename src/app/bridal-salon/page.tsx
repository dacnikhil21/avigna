              ...
              <StaggerItem key={product.id}>
                <div className="group block">
                  <div className="relative aspect-[3/4] overflow-hidden bg-luxury-cream mb-4">
                    <Image src={product.images && product.images.length > 0 && product.images[0]?.url ? product.images[0].url : "/images/hero-1.jpeg"} alt={product.images && product.images.length > 0 && product.images[0]?.altText ? product.images[0].altText : product.name} fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
