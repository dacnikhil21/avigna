      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 xl:px-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            <FadeIn>
              <p className="text-[11px] font-sans font-medium tracking-[0.35em] uppercase text-[#8A6B29] mb-6">
                Client Services
              </p>
          ...
          <div className="lg:col-span-5">
            <FadeIn delay={0.2}>
              <div className="border border-white/10 p-8 md:p-10 flex flex-col items-start bg-white/[0.02]">
                <div className="w-10 h-10 rounded-full border border-[#8A6B29]/30 flex items-center justify-center mb-6">
                  <MessageCircle className="w-5 h-5 text-[#8A6B29]" />
                </div>
                ...
                <a
                  ...
                  className="font-serif text-2xl md:text-3xl font-light text-[#8A6B29] tracking-wide hover:text-white transition-colors duration-300 mb-8 block"
                >
                  {BRAND.phone}
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center px-8 py-4 bg-[#8A6B29] hover:bg-[#FAF8F5] text-[#121212] hover:text-[#121212] text-xs uppercase tracking-[0.2em] font-medium transition-all duration-500 ease-out active:scale-[0.98] select-none text-center"
                >
                  Begin Consultation
                </a>
              </div>
