  ...
  return (
    <div className="bg-white rounded-2xl border border-[#EFECE7] p-5 sm:p-6 md:p-8 shadow-sm transition-all duration-300">
      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#EFECE7]">
        ...
        <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-wider font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 px-3 py-1 rounded-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] uppercase tracking-widest font-bold bg-[#C5A880]/20 text-[#C5A880] px-2 py-0.5 rounded-md flex items-center gap-1">
          ...
          <div className="mt-4 pt-3 border-t border-[#EFECE7]/60 flex flex-wrap items-center gap-2">
            {["GPay", "PhonePe", "Paytm", "BHIM UPI", "Visa", "Mastercard", "RuPay", "NetBanking"].map(
              (brand) => (
                <span
                  key={brand}
                  className="text-[10px] font-semibold text-[#4A4A4A] bg-white px-2.5 py-1 rounded-md border border-[#EFECE7] shadow-2xs"
                >
                  {brand}
                </span>
              )
