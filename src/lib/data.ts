...
const IMG = {
  earrings1: "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80",
  earrings2: "https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=800&q=80",
  earrings3: "https://images.unsplash.com/photo-1588444837495-c6cfeb53f32d?w=800&q=80",
  ...
  necklace3: "https://images.unsplash.com/photo-1603561596112-0a132b757442?w=800&q=80",
  ...
  ring2:     "https://images.unsplash.com/photo-1543294001-f7cd5d7fb516?w=800&q=80",
  ...
  bracelet1: "https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=800&q=80",
  ...
  generic1:  "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=800&q=80",
  generic2:  "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=800&q=80",
  generic3:  "https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=80",
  generic4:  "https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=800&q=80",
  generic5:  "https://images.unsplash.com/photo-1603561596112-0a132b757442?w=800&q=80",
};
...
export const categories: Category[] = [
  ...
  { id: "cat-long-haram",       name: "Long Haram",            slug: "long-haram",            description: "Traditional long necklaces for weddings and festivals", image: IMG.necklace2, sortOrder: 3, isActive: true },
  { id: "cat-short-haram",      name: "Short Haram",           slug: "short-haram",           description: "Elegant short harams for everyday and occasional wear", image: IMG.necklace3, sortOrder: 4, isActive: true },
  ...
  { id: "cat-glass-bangles",    name: "Glass Bangles",         slug: "glass-bangles",         description: "Colourful glass bangles with gold accents", image: IMG.bangle2, sortOrder: 6, isActive: true },
  { id: "cat-thali-chains",     name: "Thali Chains",          slug: "thali-chains",          description: "Mangalsutra and thali chains for married women", image: IMG.necklace1, sortOrder: 7, isActive: true },
  { id: "cat-panchaloham",      name: "Panchaloham Jewellery", slug: "panchaloham-jewellery", description: "Five-metal alloy jewellery for auspicious occasions", image: IMG.generic1, sortOrder: 8, isActive: true },
  { id: "cat-vaddanam",         name: "Vaddanam",              slug: "vaddanam",              description: "Ornate waist belts — essential bridal accessory", image: IMG.bridal1, sortOrder: 9, isActive: true },
  { id: "cat-champaswaralu",    name: "Champaswaralu",         slug: "champaswaralu",         description: "Traditional hair ornaments for brides and dancers", image: IMG.hair1, sortOrder: 10, isActive: true },
  { id: "cat-martilu",          name: "Martilu",               slug: "martilu",               description: "Forehead ornaments for brides and classical dancers", image: IMG.hair1, sortOrder: 11, isActive: true },
  ...
  { id: "cat-beauty-products",  name: "Beauty Products",       slug: "beauty-products",       description: "Kumkum, sindoor, and jewellery care accessories", image: IMG.generic2, sortOrder: 14, isActive: true },
  ...
  { id: "cat-long-black-beads", name: "Long Black Beads",      slug: "long-black-beads",      description: "Traditional black bead chains — the Telugu mangalsutra", image: IMG.necklace1, sortOrder: 17, isActive: true },
  { id: "cat-short-black-beads",name: "Short Black Beads",     slug: "short-black-beads",     description: "Short black bead chains for daily wear", image: IMG.necklace3, sortOrder: 18, isActive: true },
  { id: "cat-chandraharam",     name: "Chandraharam Chains",   slug: "chandraharam-chains",   description: "Traditional chandraharam moon-shaped chains", image: IMG.necklace2, sortOrder: 19, isActive: true },
  { id: "cat-beads-jewellery",  name: "Beads Jewellery",       slug: "beads-jewellery",       description: "Crystal, rudraksha, and decorative bead jewellery", image: IMG.generic3, sortOrder: 20, isActive: true },
  { id: "cat-fancy-items",      name: "Fancy Items",           slug: "fancy-items",           description: "Trendy and fashion-forward jewellery pieces", image: IMG.generic4, sortOrder: 21, isActive: true },
  ...
  { id: "cat-nose-pins",        name: "Nose Pins",             slug: "nose-pins",             description: "Elegant nose pins and naths in various styles", image: IMG.nospin1, sortOrder: 24, isActive: true },
  ...
  { id: "cat-mens",             name: "Men's Collection",      slug: "mens-collection",       description: "Chains, rings, and bracelets for men", image: IMG.ring2, sortOrder: 28, isActive: true },
  { id: "cat-kids",             name: "Kids Collection",       slug: "kids-collection",       description: "Safe, lightweight jewellery for children", image: IMG.generic5, sortOrder: 29, isActive: true },
  { id: "cat-latest",           name: "Latest Collections",    slug: "latest-collections",    description: "Our newest curation of pristine 1 gram gold jewellery drops", image: IMG.necklace1, sortOrder: 30, isActive: true }
];
