...
async function main() {
  ...
  const categoryData = [
    ...
    { id: "cat-panchaloham",      name: "Panchaloham Jewellery", slug: "panchaloham-jewellery", description: "Five-metal alloy jewellery for auspicious occasions", image: IMG.generic1, sortOrder: 8 },
    ...
    { id: "cat-beauty-products",  name: "Beauty Products",       slug: "beauty-products",       description: "Kumkum, sindoor, and jewellery care accessories", image: IMG.generic2, sortOrder: 14 },
    ...
    { id: "cat-beads-jewellery",  name: "Beads Jewellery",       slug: "beads-jewellery",       description: "Crystal, rudraksha, and decorative bead jewellery", image: IMG.generic3, sortOrder: 20 },
    { id: "cat-fancy-items",      name: "Fancy Items",           slug: "fancy-items",           description: "Trendy and fashion-forward jewellery pieces", image: IMG.generic4, sortOrder: 21 },
    ...
    { id: "cat-kids",             name: "Kids Collection",       slug: "kids-collection",       description: "Safe, lightweight jewellery for children", image: IMG.generic5, sortOrder: 29 },
  ];
